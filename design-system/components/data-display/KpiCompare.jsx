...
export function KpiCompare({ leftValue, leftLabel, rightValue, rightLabel, delta }) {
  return React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 40 } },
    React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 8, textAlign: 'right' } },
      ...
      React.createElement('div', { style: { fontFamily: 'var(--font-body)', fontSize: var(--text-caption-size), color: 'var(--text-secondary)' } }, leftLabel)
    ),
    React.createElement('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 } },
      ...
      delta && React.createElement('div', { style: { fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: var(--text-caption-size), color: 'var(--brand-primary)' } }, delta)
    ),
    React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 8 } },
      ...
      React.createElement('div', { style: { fontFamily: 'var(--font-body)', fontSize: var(--text-caption-size), color: 'var(--text-secondary)' } }, rightLabel)
    )
  );
}
