...
export function KpiBar({ label, value, percent, color = 'var(--brand-primary)', icon }) {
  return React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 12, width: '100%' } },
    React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontFamily: 'var(--font-body)', fontSize: var(--text-caption-size), color: 'var(--text-body)' } },
